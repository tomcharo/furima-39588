class OrderAddress
  ...
  attr_accessor :postal_code, :city, :address, :building, :phone_number, :prefecture_id, :user_id, :item_id

  validates :postal_code, :city, :address, :phone_number, :prefecture_id, :user_id, :item_id, presence: true
